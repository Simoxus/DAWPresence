...
namespace DAWPresenceBackgroundApp
{
    public class TrayIcon : IDisposable
    {
        ...
        private void ToggleStartup(object? sender, EventArgs e)
        {
            ...
            ConfigurationManager.Configuration.OpenOnStartup = isChecked; // Update the configuration setting
            ConfigurationManager.SaveConfiguration(); // Save the configuration to the YAML file
        }
